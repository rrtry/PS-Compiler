...
2. Логические литералы:
   `1` - Логический литерарал (означает истину)
   `0` - Логический литерал (означает ложь)
...
* return может находиться только внутри функции.
* Возвращаемый тип должен соответсвовать
## 8. Рекурсия
